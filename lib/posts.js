...
//  @param loggedInUser {string} The currently logged in user.
//	@param username	{string} The user whose posts you want to get
//	@param cb {function} Callback function to invoke after looking up posts
function getPostsByUser (loggedInUser, username, cb) {
...
// ## *function*: init
/**
	* server-side support for tweeting:
	* @ param {object} socket
	*/
