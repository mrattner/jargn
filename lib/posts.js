 ...
 *
 * @param {string} text The text characters that comprise the post
 * @param {string} author The user who authored the post
 * @param {boolean} isPrivate If true, only users who follow the author should
 * be able to see the post
 */
exports.addPost = function (text, author, isPrivate) {
	// db.User.create({
	// 	text : text,
	// 	isPrivate : isPrivate,
	// 	author : author
 ...
 * @param {string} username The user whose posts you want to get
 * @param {function} cb Callback function to invoke after looking up posts
 */
exports.getPostsByUser = function (loggedInUser, username, cb) {
